...
#ifndef __IOSTWBC-EP_H__
#define __IOSTWBC-EP_H__
...
/* Control register for P1-0 input line */
__IO_REG8    (MSC_CFGP10,  0x5031, __READ_WRITE);
/* Control register for P1-1 input line */
__IO_REG8    (MSC_CFGP11,  0x5032, __READ_WRITE);
/* Control register for P1-2 input line */
__IO_REG8    (MSC_CFGP12,  0x5033, __READ_WRITE);
/* Control register for P1-3 input line */
__IO_REG8    (MSC_CFGP13,  0x5034, __READ_WRITE);
/* Control register for P1-4 input line */
__IO_REG8    (MSC_CFGP14,  0x5035, __READ_WRITE);
/* Control register for P1-5 input line */
...
#endif
__IO_REG8_BIT(FLASH_WAIT,  0x5071, __READ, __BITS_FLASH_WAIT);
...
#endif
__IO_REG8_BIT(UART_CR5,    0x5238, __READ_WRITE, __BITS_UART_CR5);
...
#define UART_CR3_LINEN           UART_CR3_bit.LINEN

#define UART_CR4_ADD             UART_CR4_bit.ADD
#define UART_CR4_LBDF            UART_CR4_bit.LBDF
#define UART_CR4_LBDL            UART_CR4_bit.LBDL
#define UART_CR4_LBDIEN          UART_CR4_bit.LBDIEN

#define UART_CR5_IREN            UART_CR5_bit.IREN
#define UART_CR5_IRLP            UART_CR5_bit.IRLP
#define UART_CR5_HDSEL           UART_CR5_bit.HDSEL
#define UART_CR5_NACK            UART_CR5_bit.NACK
...
#define MASK_UART_CR3_LINEN      0x40

#define MASK_UART_CR4_ADD        0x0F
#define MASK_UART_CR4_LBDF       0x10
#define MASK_UART_CR4_LBDL       0x20
#define MASK_UART_CR4_LBDIEN     0x40

#define MASK_UART_CR5_IREN       0x02
#define MASK_UART_CR5_IRLP       0x04
#define MASK_UART_CR5_HDSEL      0x08
#define MASK_UART_CR5_NACK       0x10
