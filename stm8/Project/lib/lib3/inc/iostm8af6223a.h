...
#ifndef __IOSTM8AF6223A_H__
#define __IOSTM8AF6223A_H__
...
#endif
__IO_REG8_BIT(LINUART_SR,  0x5230, __READ_WRITE, __BITS_LINUART_SR);

/* LINUART data register */
__IO_REG8    (LINUART_DR,  0x5231, __READ_WRITE);
/* LINUART baud rate register 1 */
__IO_REG8    (LINUART_BRR1, 0x5232, __READ_WRITE);
/* LINUART baud rate register 2 */
__IO_REG8    (LINUART_BRR2, 0x5233, __READ_WRITE);
...
#endif
__IO_REG8_BIT(LINUART_CR1, 0x5234, __READ_WRITE, __BITS_LINUART_CR1);
...
#endif
__IO_REG8_BIT(LINUART_CR2, 0x5235, __READ_WRITE, __BITS_LINUART_CR2);
...
#endif
__IO_REG8_BIT(LINUART_CR3, 0x5236, __READ_WRITE, __BITS_LINUART_CR3);
...
#endif
__IO_REG8_BIT(LINUART_CR4, 0x5237, __READ_WRITE, __BITS_LINUART_CR4);
...
#endif
__IO_REG8_BIT(LINUART_CR6, 0x5239, __READ_WRITE, __BITS_LINUART_CR6);

/* LINUART guard time register */
__IO_REG8    (LINUART_GTR, 0x523A, __READ_WRITE);
/* LINUART prescaler register */
__IO_REG8    (LINUART_PSCR, 0x523B, __READ_WRITE);
...
#define LINUART_SR_OR            LINUART_SR_bit.OR
...
#define LINUART_CR3_LBCL         LINUART_CR3_bit.LBCL
#define LINUART_CR3_CPHA         LINUART_CR3_bit.CPHA
#define LINUART_CR3_CPOL         LINUART_CR3_bit.CPOL
#define LINUART_CR3_CKEN         LINUART_CR3_bit.CKEN
...
#define MASK_LINUART_SR_OR       0x08
...
#define MASK_LINUART_CR3_LBCL    0x01
#define MASK_LINUART_CR3_CPHA    0x02
#define MASK_LINUART_CR3_CPOL    0x04
#define MASK_LINUART_CR3_CKEN    0x08
#define MASK_LINUART_CR3_STOP    0x30
#define MASK_LINUART_CR3_LINEN   0x80
...
#define TIM5_OVR_UIF_vector                  15 /* IRQ No. in STM8 manual: 13 */
#define TIM5_CAPCOM_CC1IF_vector             16 /* IRQ No. in STM8 manual: 14 */
#define TIM5_CAPCOM_CC2IF_vector             16 /* IRQ No. in STM8 manual: 14 */
#define TIM5_CAPCOM_CC3IF_vector             16 /* IRQ No. in STM8 manual: 14 */
#define TIM5_CAPCOM_TIF_vector               16 /* IRQ No. in STM8 manual: 14 */
#define LINUART_TC_vector                    19 /* IRQ No. in STM8 manual: 17 */
#define LINUART_TXE_vector                   19 /* IRQ No. in STM8 manual: 17 */
#define LINUART_IDLE_vector                  20 /* IRQ No. in STM8 manual: 18 */
#define LINUART_LBDF_vector                  20 /* IRQ No. in STM8 manual: 18 */
#define LINUART_LHDF_vector                  20 /* IRQ No. in STM8 manual: 18 */
#define LINUART_OR_vector                    20 /* IRQ No. in STM8 manual: 18 */
#define LINUART_PE_vector                    20 /* IRQ No. in STM8 manual: 18 */
#define LINUART_RXNE_vector                  20 /* IRQ No. in STM8 manual: 18 */
...
#define TIM6_OVR_UIF_vector                  25 /* IRQ No. in STM8 manual: 23 */
