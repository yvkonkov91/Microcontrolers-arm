...
#ifndef __IOSTM8AF5286_H__
#define __IOSTM8AF5286_H__
...
#define OPT6_ADDR        0x480b
#define NOPT6_ADDR       0x480c
#define OPT7_ADDR        0x480d
#define NOPT7_ADDR       0x480e
#define OPT8_ADDR        0x4810
#define OPT9_ADDR        0x4811
#define OPT10_ADDR       0x4812
#define OPT11_ADDR       0x4813
#define OPT12_ADDR       0x4814
#define OPT13_ADDR       0x4815
#define OPT14_ADDR       0x4816
#define OPT15_ADDR       0x4817
#define OPT16_ADDR       0x4818
#define OPT17_ADDR       0x487e
#define NOPT17_ADDR      0x487f
...
#define OPT6_DECL        OPTION_BYTE_ATTRIBUTES unsigned char OPT6        @ OPT6_ADDR
#define NOPT6_DECL       OPTION_BYTE_ATTRIBUTES unsigned char NOPT6       @ NOPT6_ADDR
#define OPT7_DECL        OPTION_BYTE_ATTRIBUTES unsigned char OPT7        @ OPT7_ADDR
#define NOPT7_DECL       OPTION_BYTE_ATTRIBUTES unsigned char NOPT7       @ NOPT7_ADDR
#define OPT8_DECL        OPTION_BYTE_ATTRIBUTES unsigned char OPT8        @ OPT8_ADDR
#define OPT9_DECL        OPTION_BYTE_ATTRIBUTES unsigned char OPT9        @ OPT9_ADDR
#define OPT10_DECL       OPTION_BYTE_ATTRIBUTES unsigned char OPT10       @ OPT10_ADDR
#define OPT11_DECL       OPTION_BYTE_ATTRIBUTES unsigned char OPT11       @ OPT11_ADDR
#define OPT12_DECL       OPTION_BYTE_ATTRIBUTES unsigned char OPT12       @ OPT12_ADDR
#define OPT13_DECL       OPTION_BYTE_ATTRIBUTES unsigned char OPT13       @ OPT13_ADDR
#define OPT14_DECL       OPTION_BYTE_ATTRIBUTES unsigned char OPT14       @ OPT14_ADDR
#define OPT15_DECL       OPTION_BYTE_ATTRIBUTES unsigned char OPT15       @ OPT15_ADDR
#define OPT16_DECL       OPTION_BYTE_ATTRIBUTES unsigned char OPT16       @ OPT16_ADDR
#define OPT17_DECL       OPTION_BYTE_ATTRIBUTES unsigned char OPT17       @ OPT17_ADDR
#define NOPT17_DECL      OPTION_BYTE_ATTRIBUTES unsigned char NOPT17      @ NOPT17_ADDR
...
#define CAN_FMP_vector                       10 /* IRQ No. in STM8 manual:  8 */
#define CAN_FOVR_vector                      10 /* IRQ No. in STM8 manual:  8 */
#define CAN_FULL_vector                      10 /* IRQ No. in STM8 manual:  8 */
#define CAN_RQCP0_vector                     11 /* IRQ No. in STM8 manual:  9 */
#define CAN_RQCP1_vector                     11 /* IRQ No. in STM8 manual:  9 */
#define CAN_RQCP2_vector                     11 /* IRQ No. in STM8 manual:  9 */
#define CAN_WKUI_vector                      11 /* IRQ No. in STM8 manual:  9 */
...
#define TIM3_OVR_UIF_vector                  17 /* IRQ No. in STM8 manual: 15 */
#define TIM3_CAPCOM_CC1IF_vector             18 /* IRQ No. in STM8 manual: 16 */
#define TIM3_CAPCOM_CC2IF_vector             18 /* IRQ No. in STM8 manual: 16 */
#define TIM3_CAPCOM_CC3IF_vector             18 /* IRQ No. in STM8 manual: 16 */
#define USART_T_TC_vector                    19 /* IRQ No. in STM8 manual: 17 */
#define USART_T_TXE_vector                   19 /* IRQ No. in STM8 manual: 17 */
#define USART_R_IDLE_vector                  20 /* IRQ No. in STM8 manual: 18 */
#define USART_R_LBDF_vector                  20 /* IRQ No. in STM8 manual: 18 */
#define USART_R_PE_vector                    20 /* IRQ No. in STM8 manual: 18 */
#define USART_R_RXNE_vector                  20 /* IRQ No. in STM8 manual: 18 */
...
#define LINUART_TC_vector                    22 /* IRQ No. in STM8 manual: 20 */
#define LINUART_TXE_vector                   22 /* IRQ No. in STM8 manual: 20 */
#define LINUART_IDLE_vector                  23 /* IRQ No. in STM8 manual: 21 */
#define LINUART_LBDF_vector                  23 /* IRQ No. in STM8 manual: 21 */
#define LINUART_LHDF_vector                  23 /* IRQ No. in STM8 manual: 21 */
#define LINUART_OR_vector                    23 /* IRQ No. in STM8 manual: 21 */
#define LINUART_PE_vector                    23 /* IRQ No. in STM8 manual: 21 */
#define LINUART_RXNE_vector                  23 /* IRQ No. in STM8 manual: 21 */
#define ADC_AWD_vector                       24 /* IRQ No. in STM8 manual: 22 */
