...
#define WEOF    ((_CSTD wint_t)(-1))
                ...
                /* TYPE DEFINITIONS */
#if _DLIB_SUPPORT_FOR_STM8ABI && !defined(__AS_BOUNDS__)
  ...
  typedef _Wintt wint_t;
                ...
                /* ctype DECLARATIONS */
_C_LIB_DECL
#if !__STM8ABI_PORTABILITY_INTERNAL_LEVEL && !defined(_NO_DEFINITIONS_IN_HEADER_FILES) && !defined(__NO_WCHAR__)
...
#endif /* __STM8ABI_PORTABILITY_INTERNAL_LEVEL && _NO_DEFINITIONS_IN_HEADER_FILES */
