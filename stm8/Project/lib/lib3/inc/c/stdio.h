...
#pragma rtmodel="__dlib_file_descriptor",_STRINGIFY(_DLIB_FILE_DESCRIPTOR)
  ...
  #if !defined(__STM8ABI_PORTABLE)
    #define __STM8ABI_PORTABLE
  #endif

  #if _DLIB_FILE_DESCRIPTOR
    _C_LIB_DECL
    _DLIB_DATA_ATTR extern FILE *__stm8abi_stdin; 
    _DLIB_DATA_ATTR extern FILE *__stm8abi_stdout;
    _DLIB_DATA_ATTR extern FILE *__stm8abi_stderr;
    _END_C_LIB_DECL
...
#else /* __STM8ABI_PORTABILITY_INTERNAL_LEVEL || defined(_NO_DEFINITIONS_IN_HEADER_FILES) */
...
#endif /* __STM8ABI_PORTABILITY_INTERNAL_LEVEL || defined(_NO_DEFINITIONS_IN_HEADER_FILES) */
