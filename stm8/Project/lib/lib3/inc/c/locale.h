...
#define _M_ALL          (_CATMASK(_NCAT) - 1)
  ...
  _C_LIB_DECL
  _DLIB_CONST_ATTR extern int const __stm8abi_LC_COLLATE;
  _DLIB_CONST_ATTR extern int const __stm8abi_LC_CTYPE;
  _DLIB_CONST_ATTR extern int const __stm8abi_LC_MONETARY;
  _DLIB_CONST_ATTR extern int const __stm8abi_LC_NUMERIC;
  _DLIB_CONST_ATTR extern int const __stm8abi_LC_TIME;
  _DLIB_CONST_ATTR extern int const __stm8abi_LC_MESSAGE;
  _DLIB_CONST_ATTR extern int const __stm8abi_LC_MESSAGES;
  _DLIB_CONST_ATTR extern int const __stm8abi_LC_ALL;
  _END_C_LIB_DECL
  #define LC_COLLATE    _CSTD __stm8abi_LC_COLLATE
  #define LC_CTYPE      _CSTD __stm8abi_LC_CTYPE
  #define LC_MONETARY   _CSTD __stm8abi_LC_MONETARY
  #define LC_NUMERIC    _CSTD __stm8abi_LC_NUMERIC
  #define LC_TIME       _CSTD __stm8abi_LC_TIME
  #define LC_MESSAGE    _CSTD __stm8abi_LC_MESSAGE
  #define LC_MESSAGES   LC_MESSAGE
  #define LC_ALL        _CSTD __stm8abi_LC_ALL
...
__ATTRIBUTES struct __stm8abi_lconv *__stm8abi_localeconv(void);
#endif
#if !__STM8ABI_PORTABILITY_INTERNAL_LEVEL
...
#ifdef _STD_USING
  #if _DLIB_SUPPORT_FOR_STM8ABI
    using _CSTD __stm8abi_lconv; using _CSTD __stm8abi_localeconv;
  #endif
  #if __STM8ABI_PORTABILITY_INTERNAL_LEVEL
    using _CSTD __stm8abi_LC_COLLATE;  using _CSTD __stm8abi_LC_CTYPE;
    using _CSTD __stm8abi_LC_MONETARY; using _CSTD __stm8abi_LC_NUMERIC;
    using _CSTD __stm8abi_LC_TIME;     using _CSTD __stm8abi_LC_MESSAGE;
    using _CSTD __stm8abi_LC_MESSAGES; using _CSTD __stm8abi_LC_ALL;
  #endif
  #if !__STM8ABI_PORTABILITY_INTERNAL_LEVEL
