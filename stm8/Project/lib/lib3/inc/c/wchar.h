...
#if !defined(_NO_DEFINITIONS_IN_HEADER_FILES) && !__STM8ABI_PORTABILITY_INTERNAL_LEVEL && !defined(__NO_WCHAR__)
...
#endif /* !defined(_NO_DEFINITIONS_IN_HEADER_FILES) && !__STM8ABI_PORTABILITY_INTERNAL_LEVEL && !defined(__NO_WCHAR__) */
...
#endif /* _NO_DEFINITIONS_IN_HEADER_FILES && !__STM8ABI_PORTABILITY_INTERNAL_LEVEL && !defined(__NO_WCHAR__) */
