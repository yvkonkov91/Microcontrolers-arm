...
#if !defined(_NO_DEFINITIONS_IN_HEADER_FILES) && __STM8ABI_PORTABILITY_INTERNAL_LEVEL == 0
  #if _DLIB_ALLOW_LARGE_CONSTANT_TABLES_FOR_MATH && \
...
#endif /* !defined(_NO_DEFINITIONS_IN_HEADER_FILES) && __STM8ABI_PORTABILITY_INTERNAL_LEVEL == 0 */            
