...
/* Setup in what type we measure the size of __stm8abi_JMP_BUF_SIZE.
...
#pragma language=extended
  ...
  _C_LIB_DECL
  _DLIB_CONST_ATTR extern int const __stm8abi_JMP_BUF_SIZE;
  _END_C_LIB_DECL
...
#ifdef _STD_USING
  #if __STM8ABI_PORTABILITY_INTERNAL_LEVEL
      using _CSTD __stm8abi_JMP_BUF_SIZE;
  #endif
